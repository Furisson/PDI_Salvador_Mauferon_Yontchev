...
<qgis version="3.42.1-Münster">
  <identifier>REF_MET_Communes_littorales_BD_Carto_pol_L93</identifier>
  <parentidentifier></parentidentifier>
  <language>FR</language>
  <type>dataset</type>
  <title>REF_MET_Communes_littorales_BD_Carto_pol_L93</title>
  <abstract>Données issues de la BD Carto</abstract>
  <contact>
    <name></name>
  ...
  <extent>
    <spatial minx="0" dimensions="2" minz="0" maxx="0" maxy="0" maxz="0" miny="0" crs="EPSG:2154"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
